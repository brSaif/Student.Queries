...
namespace StudentQueries.Tests;
...
#pragma warning disable CS0162 // Unreachable code detected
                if (TestBase.UseSqlDataBase)
                    options.UseSqlServer("Server=DESKTOP-SOL3OK2;Database=Es-learn-app-queries;Integrated Security=True;TrustServerCertificate=True");
                else
